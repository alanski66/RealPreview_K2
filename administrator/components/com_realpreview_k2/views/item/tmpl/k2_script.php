	...
	switch(view){
		...
		case 'category':
			...
			$K2('#k2ImageBrowseServer').click(function(event){
				...
				SqueezeBox.fromElement(this, {
					handler: 'iframe',
					url: K2BasePath+'index.php?option=com_realpreview_k2&view=item&task=filebrowser&type=image&tmpl=component&fieldID=existingImageValue',
		...
		case 'item':
			...
			$K2('#k2MediaBrowseServer').click(function(event){
				...
				SqueezeBox.fromElement(this, {
					handler: 'iframe',
					url: K2BasePath+'index.php?option=com_realpreview_k2&view=item&task=filebrowser&type=video&tmpl=component&fieldID=remoteVideo',
			...
			$K2('.k2AttachmentBrowseServer').live('click', function(event){
				...
				SqueezeBox.fromElement(this, {
					handler: 'iframe',
					url: K2BasePath+'index.php?option=com_realpreview_k2&view=item&task=filebrowser&type=attachment&tmpl=component&fieldID=k2ActiveAttachment',
...
function addAttachment(){
	...
	var label = $K2('<a/>', {href:'index.php?option=com_realpreview_k2&view=item&task=filebrowser&type=attachment&tmpl=component&fieldID=k2ActiveAttachment', 'class':'k2AttachmentBrowseServer'}).html(K2Language[5]).appendTo(div);
